      ...
      {currentSession && (
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-4">
          ...
          <p className="text-sm text-blue-700">
            Session Period: {new Date(currentSession.startDate).toLocaleDateString()} - {new Date(currentSession.endDate).toLocaleDateString()}
          </p>
          <p className="text-sm text-blue-700">
            Registration Opens: {new Date(currentSession.registrationStartDate).toLocaleDateString()}
          </p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="requiresFee" className="ml-2 block text-sm text-gray-900">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-md pl-8 pr-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  placeholder="0.00"
                />
              </div>
            </div>
