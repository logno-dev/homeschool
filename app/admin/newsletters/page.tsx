...
import EmailRichTextEditor from '@/app/components/EmailRichTextEditor'
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[18rem_1fr]">
        ...
        <section className="rounded-lg bg-white p-5 shadow">
          ...
          {mode === 'individual' ? <IndividualEmailComposer users={users} aliases={aliases} /> : <div className="mt-5 space-y-5">
            ...
            <div><label className="block text-sm font-medium text-gray-700">Body</label><div className="mt-1 overflow-hidden rounded-md border border-gray-300"><EmailRichTextEditor value={draft.html} disabled={!canEdit || busy} onChange={(html) => setDraft({ ...draft, html })} /></div></div>
