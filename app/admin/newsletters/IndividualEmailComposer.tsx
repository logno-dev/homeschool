...
export default function IndividualEmailComposer({ users, aliases, initialUserId }: { users: User[]; aliases: string[]; initialUserId?: string }) {
  ...
  return <div className="mt-5 space-y-5">
    ...
    <div><label className="block text-sm font-medium text-gray-700">Body</label><div className="mt-1 overflow-hidden rounded-md border border-gray-300"><EmailRichTextEditor value={html} onChange={setHtml} /></div></div>
