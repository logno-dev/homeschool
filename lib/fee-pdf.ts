type FeePdfInput = { title: string; familyName: string; guardians?: string; sessionName: string; totalAmount: number; amountPaid: number; balanceDue: number; dueDate?: string; documentNumber?: string; issueDate?: string; organization?: string; organizationAddress?: string; organizationContact?: string; footer?: string }
