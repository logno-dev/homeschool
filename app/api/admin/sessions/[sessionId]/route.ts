...
export async function PATCH(
  ...
  try {
    ...
    const updateData = {
      ...
      ...(startDate && { startDate }),
      ...(endDate && { endDate }),
      ...(classTeachingRegistrationStartDate !== undefined && { classTeachingRegistrationStartDate }),
      ...(classTeachingRegistrationEndDate !== undefined && { classTeachingRegistrationEndDate }),
