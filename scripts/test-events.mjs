...
const colored = content.sanitizeEventDescription('<p><span style="color: rgb(230, 0, 0); background-color: #ffff00; position: fixed">Important</span></p>')
assert.match(colored, /color:rgb\(230, 0, 0\)/)
assert.match(colored, /background-color:#ffff00/)
assert.ok(!colored.includes('position'))
