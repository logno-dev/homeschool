...
const labels: Record<NotificationType, string> = {
  ...
  scholarship_request: 'Scholarship Request Notification',
...
const recipientFields: Partial<Record<NotificationType, keyof NotificationSettings>> = {
  ...
  scholarship_request: 'scholarshipRequestNotificationEmails',
...
const fakeValues: Record<string, string> = {
  firstName: 'Alex', familyName: 'Rivera Family', requesterName: 'Alex Rivera', applicantName: 'Alex Rivera', name: 'Alex Rivera', email: 'alex@example.com',
  ...
  balanceDue: '$0.00', donationAmount: '$50.00', dueDate: 'October 1, 2026', scholarshipType: 'Partial', requestedAmount: '$60.00', additionalInfo: 'Additional sample details.', billingStatement: sampleStatement, invoice: sampleInvoice
}
      ...
      return <Fragment key={type}>
        ...
        <section className="space-y-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <div>
            ...
            <div className="mt-1"><EmailRichTextEditor value={settings.emailTemplates[type] || ''} onChange={(value) => updateMap('emailTemplates', type, value)} disabled={isSaving} height={360} /></div>
